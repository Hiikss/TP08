...
public class ServletTestPoolConnexion extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			//Demande une connexion. La méthode getConnection met la demande en attente tant qu'il n'y a pas de connexion disponible dans le pool
			Connection cnx = dataSource.getConnection();
			out.print("La connexion est " + (cnx.isClosed()?"fermée":"ouverte"));
			//Libérer la connexion lorsque l'on n'en a plus besoin
